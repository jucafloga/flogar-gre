...
class StatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'error' => '\Flogar\Sunat\GRE\Model\StatusResponseError',
        'arc_cdr' => 'string',
    ...
    */
     ...
     * Gets error
     *
     * @return \Flogar\Sunat\GRE\Model\StatusResponseError|null
     */
     ...
     * Sets error
     *
     * @param \Flogar\Sunat\GRE\Model\StatusResponseError|null $error error
     *
     * @return self
     */
